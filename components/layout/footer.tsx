    ...
    <footer className="bg-neutral-charcoal text-white py-12 px-4">
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h4 className="font-display text-2xl font-bold mb-2 text-primary-400">Rise By Amy</h4>
            <p className="text-gray-400 mb-4">Purely Proofed. Handcrafted baked goods made with love.</p>
